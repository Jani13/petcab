                    ...
                    <div class="card-body text-dark">
                    	<div class="d-flex mb-3 justify-content-between">
                    		<div>
                    			<button class="btn btn-outline-info" 
	                      	  		  onclick="location.href='${path}/admin/info/driver'">
	                      	  		전체보기
	                      	  	</button>
                    		</div>
                      ...
                      >
                        <ul class="pagination">
                          ...
                          <!-- 맨 처음으로 -->
                          <li class="page-item">
                            <a class="page-link" href="${path}/admin/info/driver?page=1" aria-label="Previous">
                              <span aria-hidden="true">&lt;&lt;</span>
                            </a>
                          </li>
                          <!-- 이전 페이지로 -->
                          <li class="page-item">
                            <a class="page-link" href="${path}/admin/info/driver?page=${pageInfo.prvePage}" aria-label="Previous">
                              <span aria-hidden="true">&lt;</span>
                            </a>
                          </li>
                          ...
                          <c:forEach begin="${pageInfo.startPage}" end="${pageInfo.endPage}" step="1" varStatus="status">                          
                          	...
                          	<c:if test="${status.current != pageInfo.currentPage}">
	                          <li class="page-item">
	                            <a class="page-link" href="${path}/admin/info/driver?page=${status.current}
	                            							&searchType=${pageInfo.searchType}
	                            							&keyword=${pageInfo.keyword}"><c:out value="${status.current}"/></a>
	                          </li>
                          	</c:if>
                          </c:forEach>
                          ...
                          <!-- 다음 페이지로 -->
                          <li class="page-item">
                            <a class="page-link" href="${path}/admin/info/driver?page=${pageInfo.nextPage}" aria-label="Previous">
                              <span aria-hidden="true">&gt;</span>
                            </a>
                          </li>
                          ...
                          <!-- 맨 끝으로 -->
                          <li class="page-item">
                            <a class="page-link" href="${path}/admin/info/driver?page=${pageInfo.maxPage}" aria-label="Previous">
                              <span aria-hidden="true">&gt;&gt;</span>
                            </a>
                          </li>
                        </ul>
  ...
  <jsp:include page="../common/footer.jsp" />
    ...
    <script>
    	$(document).on('click', '#btnSearch', function(e){
    		...
    		var url = "${path}/admin/info/driver";
