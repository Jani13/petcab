...
<%--             <br>
            ...
            <br />
            <div>
                <form name="dogInformation" action="${path}/dog/dogInformation/enroll" method="post">
                <div class="row">
                    	...
                    	<button type="button" class="btn btn-outline-info" data-bs-toggle="collapse"
                   			 data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="margin-right: 200px;" onclick="addForm();">추가 등록</button>
  ...
  <jsp:include page="../common/footer.jsp" />
      <script>
            ...
            function addForm() {
                ...
                var str = "";
                    str+="<br><h3>추가등록</h3>"+count+"<div class='row'>"+
                        "<div class='col-md-3'></div>"+
                        "<div class='col-md-6'>"+
