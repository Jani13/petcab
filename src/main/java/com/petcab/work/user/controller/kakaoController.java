...
public class kakaoController {
	private final static String CLIENT_ID = "0115043d18bccbf110176fba3e227722"; //이런식으로 REDIRECT_URI를 써넣는다. // 
	...
	public static JsonNode getAccessToken(String autorize_code) {
		...
		postParams.add(new BasicNameValuePair("client_id", "0115043d18bccbf110176fba3e227722")); // REST API KEY
