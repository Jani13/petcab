...
ALTER TABLE REVIEW_REPLY MODIFY POST_DATE DATE DEFAULT TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS');
ALTER TABLE REVIEW_REPLY MODIFY EDIT_DATE DATE DEFAULT TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS');
